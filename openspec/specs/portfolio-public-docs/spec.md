# portfolio-public-docs Specification

## Purpose
Recruiter-facing README, screenshot slots, contribution, and architecture documentation so the public repository matches the implemented product.
